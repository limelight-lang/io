...
**Nothing the kernel touches lives on a unit's stack.** Buffers, `iovec`
...
1. [design/execution.md](design/execution.md) — the unit, the two kinds,
...
| Crate | Holds |
|---|---|
| `io-core` | the unit, switching, stacks, the scheduler, the pools, the detector |
